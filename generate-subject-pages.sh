...
@media(max-width:600px){header{padding:18px 24px}.container{padding:32px 24px 60px}.pdf-item{flex-direction:column;align-items:flex-start}.pdf-actions{width:100%}.btn{flex:1}.viewer{width:100vw;height:100vh;border-radius:0}.pdf-name{white-space:normal;overflow:visible;text-overflow:clip;font-size:14px;line-height:1.4;word-break:break-word}.pdf-info{width:100%}body::before{background-size:auto 100%;background-position:center center;}.container{padding:24px 18px 60px;max-width:100%}.cat-card{padding:13px 16px;border-radius:13px;gap:12px}.cat-name{font-size:15px}.cat-idx{font-size:13px;width:26px}.cat-count{font-size:10px}.pdf-item{padding:12px 14px;border-radius:13px}.pdf-mark{width:34px;height:34px;font-size:10px}.pdf-name{font-size:13px}.pdf-meta{font-size:10px}.btn{padding:8px 12px;font-size:12px}.pdf-list,.cat-list{gap:10px}}
</style>
</head>
<body>
<header>
